...
function Memory() {
    ...
    return (
        ...
        <div className="memory-container">
            ...
            <img src={beuni1} className="image" alt="My Profile" />
            <img src={beuni2} className="image" alt="My Profile" />
            <img src={beuni3} className="image" alt="My Profile" />
            <img src={beuni4} className="image" alt="My Profile" />
            <img src={beuni5} className="image" alt="My Profile" />
            <img src={beuni6} className="image" alt="My Profile" />
            <img src={beuni8} className="image" alt="My Profile" />
            <img src={beuni9} className="image" alt="My Profile" />
            <img src={beuni10} className="image" alt="My Profile" />
            <img src={beuni7} className="large-image" alt="My Profile" />
